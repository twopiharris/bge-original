...
def Tire_Objects():
	...
	# tire names
	frontDriver    = "FLWheel"  # front driver's tire 
	frontPassenger = "FRWheel"  # front passenger's tire 
	rearDriver     = "RLWheel"  # rear driver's tire
	rearPassenger  = "RRWheel"  # rear passenger's tire
...
def Tire_Positions():
	...
	# tire position
	tire_0_Pos = [ -0.7,   0.7,  0.0]  # front driver's tire 
	tire_1_Pos = [  0.7,   0.7,  0.0]  # front passenger's tire 
	tire_2_Pos = [ -0.7,  -0.7,  0.0]  # rear driver's tire 
	tire_3_Pos = [  0.7,  -0.7,  0.0]  # rear passenger's tire 
...
def Tire_Radius():
	...
	# tire radius
	tire_0_Radius = 0.40   # front driver's tire 
	tire_1_Radius = 0.40   # front passenger's tire 
	tire_2_Radius = 0.40   # rear driver's tire 
	tire_3_Radius = 0.40   # rear passenger's tire 
